...
class MediasService {
  async uploadImage(req: Request) {
    const files = await handleUploadImage(req) //đem từ uploadImageController qua lưu vào thư mục uploads/temp
  ...
  async uploadVideo(req: Request) {
    const files = await handleUploadVideo(req) //đem video qua lưu vào thư mục uploads/videos
